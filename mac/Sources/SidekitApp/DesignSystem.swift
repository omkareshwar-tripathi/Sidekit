...
/// The single source of truth for Sidekit's look — glass material, colors, type, spacing,
...
/// The Sidekit brand mark — the 5-bar equalizer from the app icon, in the accent gradient.
