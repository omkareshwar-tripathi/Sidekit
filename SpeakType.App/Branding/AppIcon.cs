...
namespace SpeakType.App.Branding;
...
/// embedded <c>speaktype.ico</c> — used for the .exe and window title bars. <see cref="ForState"/>
...
internal static partial class AppIcon
{
    ...
    {
        using var stream = typeof(AppIcon).Assembly.GetManifestResourceStream("speaktype.ico")
            ?? throw new InvalidOperationException("Embedded resource 'speaktype.ico' was not found.");
