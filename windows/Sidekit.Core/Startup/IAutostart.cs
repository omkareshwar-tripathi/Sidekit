namespace Sidekit.Core.Startup;
...
{
    /// <summary>True if Sidekit is registered to start at login.</summary>
    bool IsEnabled();

    /// <summary>Registers Sidekit to start at login (idempotent).</summary>
    void Enable();
